  ...
  (let ((ratecheckfunction
	  (lambda ()
	    (let* ((company (select-company-by-id 2))
		   ...
		   (oitem1 (create-odtinst-shopcart nil NandiniBlue 2 (slot-value NandiniBlue 'unit-price) 0  company))
		   (oitem2 (create-odtinst-shopcart nil NandiniGreen 2 (slot-value NandiniGreen 'unit-price) 0 company))
		   (odts (list oitem1 oitem2)))
